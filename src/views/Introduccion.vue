    ...
    .row.mb-5
      .col-lg-4.mb-3.mb-lg-0
        .bg-color-1.tarjeta.p-3.h-100(data-aos="fade-left")
          p(data-aos="fade-left") En el contexto actual de la educación, la gestión institucional adquiere un papel esencial para garantizar la calidad y pertinencia de los procesos educativos. Los Planes de Mejoramiento Institucional (PMI) se presentan como herramientas estratégicas que permiten a las escuelas identificar áreas de oportunidad, definir metas claras y diseñar acciones concretas orientadas a superar desafíos y potenciar fortalezas. Estos planes no solo fomentan una cultura de mejora continua, sino que también promueven la participación activa de toda la comunidad educativa, generando un ambiente propicio para el desarrollo integral de los estudiantes.
      .col-lg-4.mb-3.mb-lg-0
        figure
